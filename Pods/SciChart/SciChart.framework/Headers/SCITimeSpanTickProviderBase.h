...
//
// SCITimeSpanTickProviderBase.h is part of SCICHART®, High Performance Scientific Charts
...
#import "SCIDateUtil.h"

@interface SCITimeSpanTickProviderBase : SCIDeltaTickProvider {
@protected
    SCIDateUtil * dateUtil;
}
