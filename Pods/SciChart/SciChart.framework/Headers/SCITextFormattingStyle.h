...
//
// SCITextFormattingStyle.h is part of SCICHART®, High Performance Scientific Charts
...
/**
 * @brief Specifies the weight of system font to be used
 * @discussion Since iOS 13, its not possible to create system font by name, so if you need to use system font,
 * set the name nil, and specify systemFontWeight (default value - UIFontWeightRegular
 */
@property (nonatomic) UIFontWeight systemFontWeight;
