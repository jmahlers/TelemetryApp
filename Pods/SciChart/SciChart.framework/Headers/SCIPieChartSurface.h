...
@property (nonatomic, strong, nonnull) SCIAnnotationCollection *annotations __deprecated_msg("Annotations is deprecated on SCIPieChartSurface, please use regular UIView on top of SCIPieChartSurface");
