...
//
// SCIRenderableSeriesProtocol.h is part of SCICHART®, High Performance Scientific Charts
...
@protocol SCIRenderableSeriesProtocol ///
        <NSObject, SCIDrawableProtocol, SCISuspendableProtocol, SCIInvalidatableElementProtocol>
/** @{ @} */
 ...
 * @return True if has data series to draw.
 */
- (BOOL)hasDataSeries;
