...
/**
 * A base to defines a LabelProvider which uses `SCILabelFormatterProtocol` to format its labels
 */
@interface SCIFormatterLabelProviderBase : SCILabelProviderBase

/**
 * Creates a new instance of `SCIFormatterLabelProviderBase` class.
 *
