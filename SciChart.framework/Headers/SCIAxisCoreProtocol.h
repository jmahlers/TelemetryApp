...
- (void)animateVisibleRangeTo:(id <SCIRangeProtocol>)to AnimationTime:(float)duration andVelocity:(float)velocity __deprecated;
- (void)animateVisibleRangeTo:(id<SCIRangeProtocol>)to AnimationTime:(float)duration velocity:(float)velocity rangeLimit:(id<SCIRangeProtocol>)rangeLimit __deprecated;
