...
/**
 * The `SCINumericLabelProvider` is a pass-through which uses the `SCIAxisCoreProtocol#textFormatting` and SCIAxisCoreProtocol#cursorTextFormatting properties
