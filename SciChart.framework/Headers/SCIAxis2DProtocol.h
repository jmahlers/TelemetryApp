 ...
 * @see SCIClipMode
 */
- (void)scrollByPixels:(double)pixelsToScroll ClipMode:(SCIClipMode)clipMode AnimationTime:(float)duration Velocity:(float)velocity __deprecated;
 ...
 * @see SCIRange
 */
- (void)scrollByDataPoints:(int)pointAmount __deprecated;
 ...
 * @see SCIClipMode
 */
- (void)scrollByDataPoints:(int)pointAmount AnimationTime:(float)duration __deprecated;
 ...
 * @see SCIRange
 */
- (void)scrollToPixels:(double)pixelsToScroll WithVisibleRange:(id <SCIRangeProtocol>)startVisibleRange WithLimit:(id <SCIRangeProtocol>)rangeLimit __deprecated;
