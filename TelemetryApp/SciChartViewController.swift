...
//    }
//    
//    var chart: SmallSciChartContainer!
//    
...
//        super.viewDidLoad()
//        
//        chart = SmallSciChartContainer(frame: self.view.frame)
//        
...
//        lineDataSeries.fifoCapacity = Int32(chart.secondsInPastToPlot*SmallSciChartContainer.frequency+Double(chart.rollAvgStorage.count))
...
//        let recentPoints:[DataPoint] = points.suffix(suffixLength ?? Int(chart.secondsInPastToPlot*SmallSciChartContainer.frequency))
//
//        
